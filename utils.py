...
def net_builder(
    net_name, from_name: bool, net_conf=None, pretrained=False, in_channels=3, segmentation=False
):
    """
    ...
    if from_name:
        ...
        if net_name == "WideResNet":
            ...
            if not segmentation:
                ...
                if pretrained:
                    print("Using pretrained", net_name, "...")  # model output channels (number of classes in your dataset)
                    return lambda num_classes, in_channels: smp.Unet(
                        encoder_name=net_name,  # choose encoder, e.g. mobilenet_v2 or efficientnet-b7
